...
<head>
	...
	<title><?php single_cat_title(); ?> - Marquitetura</title>
	<?php wp_head(); ?>
</head>
<body <?=body_class();?>>
		...
		<div class="container postContent">
			<div class="row">
				<div class="col-md-12 breadcrumb">
					<a href="<?=get_site_url()?>"><i class="fa fa-home" aria-hidden="true"></i></a> / <a href="<?=get_site_url()?>/blog/">blog</a> / <span>Tags</span> / <span><?php single_cat_title(); ?></span>
				</div>
				<div class="col-md-12">
	...
	<div class="container blogPage">
		<?php
			...
			$wp_query = new WP_Query(array('tag_id'=>$add,'posts_per_page' => 5,"paged" => $paged,'meta_query' => array(array('key' => '_thumbnail_id'))));
